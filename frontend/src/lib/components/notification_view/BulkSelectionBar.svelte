<script lang="ts">
	...
	const iconButtonClass =
		"flex h-9 w-9 items-center justify-center rounded-full bg-transparent text-gray-700 dark:text-gray-300 transition hover:bg-gray-200 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-600/40 disabled:opacity-50 cursor-pointer";
</script>
...
{#if multiselectMode}
	<div class="ml-1 flex items-center gap-1 text-sm">
		...
		<span class="ml-auto text-xs text-gray-500 dark:text-gray-400">{displayText}</span>

		<button
			class="ml-1 mr-1 flex h-7 items-center rounded-full bg-white dark:bg-gray-900 px-3 text-xs font-medium text-gray-600 dark:text-gray-300 transition hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50 cursor-pointer"
			type="button"
