...
// Inbox tray icon (stroke). Shared by the sidebar, the row's "Move to inbox" action,
// and the "skipped inbox" row badge.
export const inboxIconPath =
...
// Diagonal slash overlaid on the inbox icon to mean "not in the inbox" (skipped inbox),
// following the bell-slash / eye-slash convention.
export const inboxSlashPath = "M4 4L20 20";
