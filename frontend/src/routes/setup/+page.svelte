		...
		{:else}
			...
			<div class="mt-8">
				...
				>
					...
					{:else}
						<!-- Not connected state - OAuth and PAT as equal options -->
						<div class="space-y-6">
							{#if connectionError}
								<div
							...
							<div class="text-center py-2">
								<!-- PAT Option (Recommended) -->
								<div>
									<div class="mb-3">
										<button
											type="button"
											on:click={() => (showPatInput = !showPatInput)}
											class="w-full inline-flex items-center justify-center gap-3 rounded-xl bg-indigo-600 px-7 py-3.5 text-sm font-semibold text-white transition-all hover:bg-indigo-500 cursor-pointer shadow-sm hover:shadow-md"
										>
											<svg
												class="h-5 w-5"
												aria-hidden="true"
									...
									<p class="text-xs text-gray-500 dark:text-gray-400 mb-4 text-center">
										Works with most GitHub organizations and gives you full control over token
										scopes
									</p>
										...
										>
											...
											<div class="flex gap-2">
												<input
													...
													class="flex-1 rounded-lg border-2 border-indigo-300 dark:border-indigo-700 bg-white dark:bg-gray-800 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 transition-colors focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white dark:placeholder-gray-500 dark:focus:border-indigo-400 dark:focus:ring-indigo-400"
												...
												<button
													...
													class="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white transition-all hover:bg-indigo-500 disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
												>
								...
								<div class="mb-4">
									<button
										...
										class="w-full inline-flex items-center justify-center gap-3 rounded-xl bg-gray-900 dark:bg-white px-7 py-3.5 text-sm font-semibold text-white dark:text-gray-900 transition-all hover:bg-gray-800 dark:hover:bg-gray-100 cursor-pointer shadow-sm hover:shadow-md"
									>
										<svg class="h-5 w-5" aria-hidden="true" focusable="false" fill="currentColor" viewBox="0 0 24 24">
											<path
												d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"
											/>
										</svg>
									...
									<p class="text-xs text-gray-500 dark:text-gray-400 mt-3 text-center">
										Requires your organization to grant access to the Octobud OAuth app
									</p>
								</div>
							</div>
						</div>
