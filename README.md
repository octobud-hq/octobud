...
**[Download Latest Release](https://github.com/octobud-hq/octobud/releases/latest)** - Automatically detects your OS and downloads the appropriate installer:
...
Download the latest release from the [Releases page](https://github.com/octobud-hq/octobud/releases) and install the `.pkg` file. Octobud will appear in your menu bar and open automatically in your browser.

### Linux & Windows (Partial Support)

Build from source and run the binary. The app will be accessible at `http://localhost:8808` in your browser. Note: Menu bar integration and auto-start are not available on these platforms.
